...
def train(train_loader, valid_loader, test_loader, args):
    ...
    plt.legend()
    # 保存圖片
    plt.savefig(f'loss_curves/loss_curves_CNN_RNN_epoch{args.max_epoch}_early_stop{args.early_stop_mode}.png')
    plt.show()
...
def test(test_loader, args):
    ...
    with torch.no_grad():
        ...
        ax.legend()
        # 保存圖片
        plt.savefig(f'testing_result/testing_result_CNN_RNN_epoch{args.max_epoch}_early_stop{args.early_stop_mode}.png')
        plt.show()
...
if __name__ == '__main__':
    ...
    train_input = torch.load(r"/home/0283901/chu1/3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main/data/torch-data/train_input.pt").float()
    ...
    train_label = torch.load(r"/home/0283901/chu1/3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main/data/torch-data/train_label.pt").float()
    ...
    test_input = torch.load(r"/home/0283901/chu1/3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main/data/torch-data/test_input.pt").float()
    ...
    test_label = torch.load(r"/home/0283901/chu1/3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main/data/torch-data/test_label.pt").float()
    ...
    valid_input = torch.load(r"/home/0283901/chu1/3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main/data/torch-data/valid_input.pt").float()
    ...
    valid_label = torch.load(r"/home/0283901/chu1/3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main/data/torch-data/valid_label.pt").float()
