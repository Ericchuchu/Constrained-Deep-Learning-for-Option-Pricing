...
for i in trange(train_data['optID'].unique().shape[0]):
    for index in range(train_data.loc[(train_data['optID'] == train_data['optID'].unique()[i])].shape[0] - seq_len):
        ...
        # 論文中的 inventory 和 spotprice 的位置是互換的
...
torch.save(train_input, r"C:\Users\Admin\Desktop\option pricing專題\conv-LSTM run code\3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main\data\torch-data\train_input.pt")
torch.save(train_label, r"C:\Users\Admin\Desktop\option pricing專題\conv-LSTM run code\3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main\data\torch-data\train_label.pt")
torch.save(test_input, r"C:\Users\Admin\Desktop\option pricing專題\conv-LSTM run code\3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main\data\torch-data\test_input.pt")
torch.save(test_label, r"C:\Users\Admin\Desktop\option pricing專題\conv-LSTM run code\3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main\data\torch-data\test_label.pt")
torch.save(valid_input, r"C:\Users\Admin\Desktop\option pricing專題\conv-LSTM run code\3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main\data\torch-data\valid_input.pt")
torch.save(valid_label, r"C:\Users\Admin\Desktop\option pricing專題\conv-LSTM run code\3D-Tensor-based-Deep-Learning-Models-for-Predicting-Option-Price-main\data\torch-data\valid_label.pt")
